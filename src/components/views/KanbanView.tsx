...
const KanbanView: React.FC = () => {
  ...
  const TaskCard = ({ task }: { task: Task }) => (
    ...
    >
      ...
      {Object.keys(task.customFields).length > 0 && (
        <div className="mt-2 pt-2 border-t border-gray-200" data-cy="custom-fields">
  ...
  return (
    <div className="h-full flex justify-center align-center" data-cy="kanban-view">
                  ...
                  {(provided, snapshot) => (
                    ...
                    >
                      {priorityTasks.length === 0 ? (
                        <p className="text-gray-400 text-sm text-center py-4" data-cy="no-tasks">
                          No tasks
                        </p>
                      ) : (
