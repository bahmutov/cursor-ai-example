...
const ListView: React.FC = () => {
  ...
  return (
    <div className="bg-white shadow rounded-lg overflow-hidden" data-cy="list-view">
      {/* Bulk actions bar */}
      {selectedTaskIds.size > 0 && (
        <div className="bg-blue-50 px-4 py-2 flex items-center justify-between border-b">
          <span className="text-sm text-blue-700 font-medium" data-cy="selected-tasks">
            ...
            <tr>
              <th className="px-3 py-3 text-left">
                <input
                  type="checkbox"
                  checked={
                    paginatedTasks.length > 0 && selectedTaskIds.size === paginatedTasks.length
                  }
            ...
            {paginatedTasks.map(task => (
              <tr key={task.id} className="hover:bg-gray-50" data-cy="task-row">
                ...
                <td className="px-6 py-4">
                  <div className="text-sm font-medium text-gray-900" data-cy="task-title">
                    {task.title}
                  </div>
                  {task.description && (
                    <div
      ...
      {totalPages > 1 && (
        <div className="px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
          <div className="flex-1 flex justify-between sm:hidden" data-cy="mobile-pagination">
            {/* Mobile pagination */}
            <button
            ...
            <span className="text-sm text-gray-700 ml-1" data-cy="pagination-info">
